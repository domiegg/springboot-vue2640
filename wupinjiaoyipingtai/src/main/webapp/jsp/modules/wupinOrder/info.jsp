            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">物品订单登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="wupinKucunNumber" name="wupinKucunNumber" class="form-control"
                                                   v-model="ruleForm.wupinKucunNumber" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>点击次数</label>
                                            <input style="width: 450px" id="wupinClicknum" name="wupinClicknum" class="form-control"
                                                   v-model="ruleForm.wupinClicknum" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="wupinOrderUuidNumber" name="wupinOrderUuidNumber" class="form-control"
                                               v-model="ruleForm.wupinOrderUuidNumber" readonly>
                                    </div>
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="wupinOrderTruePrice" name="wupinOrderTruePrice" class="form-control"
                                               v-model="ruleForm.wupinOrderTruePrice" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="wupinOrderCourierName" name="wupinOrderCourierName" class="form-control"
                                               v-model="ruleForm.wupinOrderCourierName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="wupinOrderCourierNumber" name="wupinOrderCourierNumber" class="form-control"
                                               v-model="ruleForm.wupinOrderCourierNumber" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>订单类型</label>
                                    <input style="width: 450px" id="wupinOrderValue" name="wupinOrderValue" class="form-control"
                                           v-model="ruleForm.wupinOrderValue" readonly>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>支付类型</label>
                                    <input style="width: 450px" id="wupinOrderPaymentValue" name="wupinOrderPaymentValue" class="form-control"
                                           v-model="ruleForm.wupinOrderPaymentValue" readonly>
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "wupinOrder/info/" + id,
