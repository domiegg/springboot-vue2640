            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">物品展示</span>
                    ...
                    <div class="project-sec pt-100 pb-70">
                        <div class="row">
                            <div v-for="(item,index) in dataList" v-bind:key="index" class="col-md-3 col-sm-6">
                                <div class="item" @click="jumpCheck('../wupin/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
