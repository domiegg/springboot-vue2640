        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div>
                        <div v-for="(item,index) in wupinList" v-bind:key="index" class="col-md-3 col-sm-3 col-xs-6 w3gallery-grids">
                            <div class="imghvr-hinge-right figure" style="width: 100%" @click="jumpCheck('../wupin/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                <img :src="item.wupinPhoto?item.wupinPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                <div class="agile-figcaption">
                                    <h4>{{item.wupinName}}</h4>
                                    <h4 v-if="item.wupinNewMoney">
            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right"><img src="../../xznstatic/img/insie1.png" alt="" /></span>
                            <span class="ng-inmod-the-bg ng-inmod-the-bg-right" aos="fade-up-left"><img src="../../xznstatic/img/insie2.png" alt="" /></span>
                            <span class="ng-inmod-the-cn" aos="fade-down">商家展示</span>
                            <span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
                        </div>
                        <span class="ng-inmod-thebor" aos="fade-up"></span>
                    </div>
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div>
                        <div v-for="(item,index) in shangjiaList" v-bind:key="index" class="col-md-3 col-sm-3 col-xs-6 w3gallery-grids">
