            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">物品收藏展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                          ...
                          <div class="layui-inline" style="margin-bottom: 10px;">
                              ...
                              <div class="layui-input-inline">
                                  <input type="text" name="wupinNewMoneyStart" id="wupinNewMoneyStart"  lay-skin="double"   placeholder="现价开始" autocomplete="off" class="layui-input">
                              </div>
                          </div>
                          <div class="layui-inline" style="margin-bottom: 10px;">
                              <div class="layui-input-inline" style="margin-top: -5px">
                                  <input type="text" name="wupinNewMoneyEnd"   id="wupinNewMoneyEnd"    lay-skin="double|wupinNewMoneyEnd"   placeholder="现价结束" autocomplete="off" class="layui-input">
                              </div>
                          </div>
                    ...
                    <div class="project-sec pt-100 pb-70">
                        <div class="row">
                            <div v-for="(item,index) in dataList" v-bind:key="index" class="col-md-3 col-sm-6">
                                <i @click="deleteWupinCollection(item.id)" class="layui-icon" style="float:right;color:red;margin-top: 0px;margin-right: 3px;font-size:20px">&#xe640;</i>
                                <div class="item" @click="jumpCheck('../wupin/detail.jsp?id='+item.wupinId , item.wupinDelete == null?'':item.wupinDelete , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                    <div class="project-thumb">
                                        <img :src="item.wupinPhoto?item.wupinPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                        <div class="project-hoverlay">
                                            <div class="project-text">
                                                <h3 v-if="item.wupinNewMoney">
                                                    {{item.wupinNewMoney}} RMB
                                                </h3>
                                                <h3 v-else>
                                                    {{item.wupinValue}}
                                                </h3>
...
<script>
    ...
    // 级联表的字段数据
        ...
        form.verify({
            ...
            ,wupinNewMoneyEnd: function(value, item){ //value：表单的值、item：表单的DOM对象
                var wupinNewMoneyStart = $("#wupinNewMoneyStart").val();
                if(wupinNewMoneyStart != null && wupinNewMoneyStart != "" && wupinNewMoneyStart != "null"){
                    var number = parseInt(value)- parseInt(wupinNewMoneyStart);
                    if(number<0){
                        return '现价的结束值不能小于开始值';
                    }
                }
            }
        ...
        function pageList() {
            ...
            if (jquery('#wupinNewMoneyStart').val() != null && jquery('#wupinNewMoneyStart').val() != "" && jquery('#wupinNewMoneyStart').val() != "null" ) {
                param['wupinNewMoneyStart'] = jquery('#wupinNewMoneyStart').val();
            }
            if (jquery('#wupinNewMoneyEnd').val() != null && jquery('#wupinNewMoneyEnd').val() != "" && jquery('#wupinNewMoneyEnd').val() != "null" ) {
                param['wupinNewMoneyEnd'] = jquery('#wupinNewMoneyEnd').val();
            }
